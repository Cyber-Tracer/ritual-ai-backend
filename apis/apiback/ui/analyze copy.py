...
from ..public import save_scores, get_score, save_properties, get_properties
...
def save_score(solution):
    ...
    try:
        if (soulutionType == 'unsupervised'):
            ...
            uploaddic2['equal_opportunity_difference_property']=None
            uploaddic2['average_odds_difference_property'] =None
            uploaddic2['class_balance_property']=None
            uploaddic2['feature_relevance_property']=None
            uploaddic2['algorithm_class_property']=None
            uploaddic2['confidence_score_property']=None
            uploaddic2['clique_method_property']=None
            uploaddic2['er_fast_gradient_attack_property']= None
            uploaddic2['er_carlini_wagner_attack_property']= None
            uploaddic2['er_deepfool_attack_property']=None
            uploaddic2['loss_sensitivity_property']=None


            uploaddic2['underfitting_property']=uploaddic['underfitting_property']
            uploaddic2['overfitting_property']=uploaddic['overfitting_property']
            uploaddic2['statistical_parity_difference_property']=uploaddic['statistical_parity_difference_property'] 
            uploaddic2['disparate_impact_property']=uploaddic['disparate_impact_property']
            uploaddic2['class_balance_property']=uploaddic['class_balance_property']
            uploaddic2['correlated_features_property']=uploaddic['correlated_features_property']
            uploaddic2['model_size_property']=uploaddic['model_size_property']
            uploaddic2['permutation_feature_importance_property']=uploaddic['permutation_feature_importance_property']
            uploaddic2['normalization_property']=uploaddic['normalization_property'] 
            uploaddic2['missing_data_property']=uploaddic['missing_data_property'] 
            uploaddic2['regularization_property']=uploaddic['regularization_property']
            uploaddic2['train_test_split_property']=uploaddic['train_test_split_property']
            uploaddic2['factsheet_completeness_property']=uploaddic['factsheet_completeness_property']
            uploaddic2['clever_score_property']=uploaddic['clever_score_property']
            ...
            uploaddic2['overfitting_property']=uploaddic['overfitting_property']
            uploaddic2['statistical_parity_difference_property']=uploaddic['statistical_parity_difference_property'] 
            uploaddic2['equal_opportunity_difference_property']=uploaddic['equal_opportunity_difference_property']
            uploaddic2['average_odds_difference_property'] =uploaddic['average_odds_difference_property'] 
            uploaddic2['disparate_impact_property']=uploaddic['disparate_impact_property']
            uploaddic2['class_balance_property']=uploaddic['class_balance_property']
            uploaddic2['algorithm_class_property']=uploaddic['algorithm_class_property']
            uploaddic2['correlated_features_property']=uploaddic['correlated_features_property']
            uploaddic2['model_size_property']=uploaddic['model_size_property']
            uploaddic2['feature_relevance_property']=uploaddic['feature_relevance_property']
            uploaddic2['permutation_feature_importance_property']=uploaddic['permutation_feature_importance_property']
            uploaddic2['normalization_property']=uploaddic['normalization_property'] 
            uploaddic2['missing_data_property']=uploaddic['missing_data_property'] 
            uploaddic2['regularization_property']=uploaddic['regularization_property']
            uploaddic2['train_test_split_property']=uploaddic['train_test_split_property']
            uploaddic2['factsheet_completeness_property']=uploaddic['factsheet_completeness_property']
            uploaddic2['confidence_score_property']=uploaddic['confidence_score_property'] 
            uploaddic2['clique_method_property']=uploaddic['clique_method_property'] 
            uploaddic2['clever_score_property']=uploaddic['clever_score_property']
            uploaddic2['er_fast_gradient_attack_property']= uploaddic['er_fast_gradient_attack_property']
            uploaddic2['er_carlini_wagner_attack_property']= uploaddic['er_carlini_wagner_attack_property'] 
            uploaddic2['er_deepfool_attack_property']=uploaddic['er_deepfool_attack_property']
            uploaddic2['loss_sensitivity_property']=uploaddic['loss_sensitivity_property'] 
        
            # -- end

        save_scores(solution.id, uploaddic)
        save_properties(solution.id, uploaddic2)
        ...
        if request.data is not None:
            ...
            if (solution.solution_type == 'supervised'):
                explain = get_explainability_score_supervised(
                    model_data, train_data, test_data, factsheet, mappings, target_column, outliers_data)
            ...
            try:
                a = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")
            except:
                pass
            try:
                uploaddic['accuracy'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["accuracy"]
            ...
            try:
                uploaddic['globalrecall'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["global recall"]
            ...
            try:
                uploaddic['classweightedrecall'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["class weighted recall"]
            ...
            try:
                uploaddic['globalprecision'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["global precision"]
            ...
            try:
                uploaddic['classweightedprecision'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["class weighted precision"]
            ...
            try:
                uploaddic['globalf1score'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["global f1 score"]
            ...
            try:
                uploaddic['classweightedf1score'] = get_performance_metrics_supervised(
                    model=model_data, test_data=test_data, target_column="Target")["class weighted f1 score"]
