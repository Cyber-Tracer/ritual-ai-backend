...
class compare(APIView):
    def post(self, request):
        ...
        if request.data is not None:
            ...
            try:
                a=get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")
            except:
                pass
            try:
                uploaddic['accuracy'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["accuracy"]
            ...
            try:
                uploaddic['globalrecall'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["global recall"]
                print("Gloabl Recall is: ", uploaddic['globalrecall'])
            except:
                print("Recall ERROR")
                pass
            try:
                uploaddic['classweightedrecall'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["class weighted recall"]
                print("Classweighted Recall is: ", uploaddic['classweightedrecall'])
            except:
                print("Classweighted Recall ERROR")
                pass
            try:
                uploaddic['globalprecision'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["global precision"]
                print("Global Precision is: ", uploaddic['globalprecision'])
            except:
                print("Global Precision ERROR")
                pass
            try:
                uploaddic['classweightedprecision'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["class weighted precision"]
                print("Classweighted Precision is:", uploaddic['classweightedprecision'])
            except:
                print("Classweighted Precision ERROR")
                pass
            try:
                uploaddic['globalf1score'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["global f1 score"]
                ...
                pass
            try:
                uploaddic['classweightedf1score'] = get_performance_metrics_supervised(model=model_data1,test_data=test_data1,target_column="Target")["class weighted f1 score"]
                print("Classweightedf1score is:", uploaddic['classweightedf1score'])
            ...
            try:
                a=get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")
            except:
                pass
            try:
                uploaddic['accuracy2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["accuracy"]
                print("Accuracy2: ", uploaddic['accuracy2'])
            except:
                print("Accuracy2 ERROR")
                pass
                
            try:
                uploaddic['globalrecall2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["global recall"]
                print("Gloabl Recall2 is: ", uploaddic['globalrecall2'])
            except:
                print("Recall2 ERROR")
                pass
            try:
                uploaddic['classweightedrecall2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["class weighted recall"]
                print("Classweighted Recall2 is: ", uploaddic['classweightedrecall2'])
            except:
                print("Classweighted Recall2 ERROR")
                pass
            try:
                uploaddic['globalprecision2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["global precision"]
                print("Global Precision2 is: ", uploaddic['globalprecision2'])
            except:
                print("Global Precision2 ERROR")
                pass
            try:
                uploaddic['classweightedprecision2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["class weighted precision"]
                print("Classweighted Precision2 is:", uploaddic['classweightedprecision2'])
            except:
                print("Classweighted Precision2 ERROR")
                pass
            try:
                uploaddic['globalf1score2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["global f1 score"]
                print("Global F1 Score2 is:", uploaddic['globalf1score2'])

            except:
                print("Global F1 Score2 ERROR")
                pass
            try:
                uploaddic['classweightedf1score2'] = get_performance_metrics_supervised(model=model_data2,test_data=test_data2,target_column="Target")["class weighted f1 score"]
                print("Classweightedf1score2 is:", uploaddic['classweightedf1score2'])

            except:
                print("Classweightedf1score2 ERROR")
                pass


            print("FACTSHEET VALUES: ",factsheet1["properties"]["methodology"]["factsheet_completeness"])
