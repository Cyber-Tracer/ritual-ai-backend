# Generated by Django 4.1.5 on 2023-04-10 18:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statistical_parity_difference_property', models.JSONField(max_length=1000, null=True)),
                ('equal_opportunity_difference_property', models.JSONField(max_length=1000, null=True)),
                ('average_odds_difference_property', models.JSONField(max_length=1000, null=True)),
                ...
                ('permutation_feature_importance_property', models.JSONField(max_length=1000, null=True)),
                ...
                ('factsheet_completeness_property', models.JSONField(max_length=1000, null=True)),
                ...
                ('er_fast_gradient_attack_property', models.JSONField(max_length=1000, null=True)),
                ('er_carlini_wagner_attack_property', models.JSONField(max_length=1000, null=True)),
