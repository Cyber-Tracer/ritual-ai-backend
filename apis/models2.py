...
class Properties(models.Model):
    ...
    # Fairness
    fairness = models.TextField(null=True)
    underfitting = models.TextField(null=True)
    overfitting = models.TextField(null=True)
    statistical = models.TextField(null=True)
    disparate = models.TextField(null=True)
    equal = models.TextField(null=True)
    average = models.TextField(null=True)
    class_balance = models.TextField(null=True)

    # explainability
    explain = models.TextField(null=True)
    correlated = models.TextField(null=True)
    model_size = models.TextField(null=True)
    permutation = models.TextField(null=True)
    feature = models.TextField(null=True)
    algorithm = models.TextField(null=True)

    # robustness
    robust = models.TextField(null=True)
    clever = models.TextField(null=True)
    confidence = models.TextField(null=True)
    clique = models.TextField(null=True)
    er_fast = models.TextField(null=True)
    er_carlini = models.TextField(null=True)
    er_deep = models.TextField(null=True)
    loss_sensitivity = models.TextField(null=True)

    # accountability
    account = models.TextField(null=True)
    train_test_split = models.TextField(null=True)
    missing_data = models.TextField(null=True)
    normalization = models.TextField(null=True)
    regularization = models.TextField(null=True)
    factsheet = models.TextField(null=True)
...
class Performancemetrics(models.Model):
    ...
    global_recall = models.FloatField(null=True)
    class_weighted_recall = models.FloatField(null=True)
    global_precision = models.FloatField(null=True)
    class_weighted_precision = models.FloatField(null=True)
    global_f1_score = models.FloatField(null=True)
    class_weighted_f1_score = models.FloatField(null=True)
